...
for zone in token_zones:
	source_code += 'is_token_' + zone[1] + ' :: inline(t: Token_Kind) -> bool do return t > Token_Kind._' + zone[0] + 'Begin && t < Token_Kind._' + zone[0] + 'End;\n';
	source_code += 'is_token_' + zone[1] + ' :: inline(t: Token) -> bool do return is_token_' + zone[1] + '(t.kind);\n\n';
